package com.syedriadh.cart.userservice.configuration.authentication.entrypoint;
...
public class BearerAuthenticationEntryPoint implements AuthenticationEntryPoint {
    ...
    public void commence(HttpServletRequest request, HttpServletResponse response, AuthenticationException authException)
        ...
        GlobalErrorResponse errorResponse = new GlobalErrorResponse(request, HttpStatus.UNAUTHORIZED, "Authentication is required to access this resource");
